...
import com.example.backend_nutripoint.DTO.DetalleCompraRequestDTO;
import com.example.backend_nutripoint.DTO.DetalleCompraResponseDTO;
    ...
    public CompraResponseDTO realizarCompra(CompraRequestDTO dto, String emailUser) {
        ...
        for (DetalleCompraRequestDTO detalleDTO : dto.getDetalles()) {
            ...
            if (prod.getStock() < detalleDTO.getCantidad()) {
                throw new IllegalArgumentException("Stock insuficiente, producto: "+prod.getNombre()+", stock: "+prod.getStock());
            }
